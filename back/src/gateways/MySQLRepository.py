...
class MySQLRepository(Repository):
    ...
    def _queryDB(self, query: str, params: tuple = None, *, error_message:str = None, fetch_all: bool = False, fetch_one: bool = False) -> Union[bool,str,list[tuple],tuple]:
        """
    ...
    def createUser(self, email: str, password: str, name: str) -> Union[bool,str]:
        ...
        try:
            ...
            result = self._queryDB(query, (email, hashed_password, salt, name), error_message='An error ocurred while creating the user in the database')
    ...
    def getUserById(self, id: int) -> Union[User,str]:
        ...
        result =self._queryDB(query, (id,), fetch_one=True, error_message='An error ocurred while retrieving the user from the database')
    ...
    def getUsersByRole(self, role: str) -> Union[list[User],str]:
        ...
        results = self._queryDB(query, (role,), fetch_all=True, error_message='An error ocurred while retrieving the users from the database')
    ...
    def getAllUsers(self) -> Union[list[User],str]:
        ...
        results = self._queryDB(query, fetch_all=True, error_message='An error ocurred while retrieving the users from the database')
    ...
    def updateUserData(self, user: User) -> Union[bool,str]:
        ...
        return self._queryDB(query, (user.email, user.name, user.id), error_message='An error ocurred while updating the user in the database')
    ...
    def updateUserPassword(self, user:User) -> Union[bool,str]:
        ...
        try:
            ...
            return self._queryDB(query, (hashed_password, salt, user.id), error_message='An error ocurred while updating the user in the database')
        except HashingError as e:
            return 'An error ocurred while hashing the password'
    ...
    def deleteUser(self, id: int) -> Union[bool,str]:
        ...
        return self._queryDB(query, (id,), error_message='An error ocurred while deleting the user from the database')
    ...
    def validateUser(self, user:User) -> Union[bool,str]:
        ...
        try:
            ...
            return 'An error ocurred while hashing or validating the password'

    def linkRoleToUser(self, user_id: int, role_id: int) -> Union[bool,str]:
        query = 'INSERT INTO `user_role` (`user_id`, `role_id`) VALUES (%s, %s)'

        return self._queryDB(query, (user_id, role_id), error_message='An error ocurred while relating the role to the user in the database')
    ...
    def unlinkRoleToUser(self, user_id: int, role_id: int) -> Union[bool,str]:
        ...
        return self._queryDB(query, (user_id, role_id), error_message='An error ocurred while unrelating the role to the user in the database')

    def createRole(self, name: str) -> Union[bool,str]:
        query = 'INSERT INTO `role` (`name`) VALUES (%s)'

        return self._queryDB(query, (name,), error_message='An error ocurred while creating the role in the database')

    def getRoleById(self, id: int) -> Union[Role,str]:
        query = 'SELECT `id`, `name` FROM `role` WHERE `id` = %s'

        result = self._queryDB(query, (id,), fetch_one=True, error_message='An error ocurred while retrieving the role from the database')
    ...
    def updateRole(self, role: Role) -> Union[bool,str]:
        ...
        return self._queryDB(query, (role.name, role.id), error_message='An error ocurred while updating the role in the database')

    def deleteRole(self, id: int) -> Union[bool,str]:
        query = 'DELETE FROM `role` WHERE `id` = %s'

        return self._queryDB(query, (id,), error_message='An error ocurred while deleting the role from the database')
    ...
    def createProvider(self, name: str, description: str, country:str) -> Union[bool,str]:
        ...
        return self._queryDB(query, (name, description, country), error_message='An error ocurred while creating the provider in the database')
    ...
    def getProviderById(self, id: int) -> Union[Provider,str]:
        ...
        result = self._queryDB(query, (id,), fetch_one=True, error_message='An error ocurred while retrieving the provider from the database')
    ...
    def getProviderByName(self, name: str) -> Union[Provider,str]:
        ...
        result = self._queryDB(query, (name,), fetch_one=True, error_message='An error ocurred while retrieving the provider from the database')
    ...
    def getAllProviders(self) -> Union[list[Provider],str]:
        ...
        results = self._queryDB(query, fetch_all=True, error_message='An error ocurred while retrieving the providers from the database')
    ...
    def updateProvider(self, provider: Provider) -> Union[bool,str]:
        ...
        return self._queryDB(query, (provider.name, provider.description, provider.country, provider.id), error_message='An error ocurred while updating the provider in the database')
        
    def deleteProvider(self, id: int) -> Union[bool,str]:
        query = 'DELETE FROM `provider` WHERE `id` = %s'

        return self._queryDB(query, (id,), error_message='An error ocurred while deleting the provider from the database')
    ...
    def createRisk(self, provider_id:int, name: str, description: str, probability: Classification, impact: Classification) -> Union[bool,str]:
        ...
        return self._queryDB(query, (provider_id, name, description, probability.value, impact.value), error_message='An error ocurred while creating the risk in the database')
    ...
    def getRiskById(self, id: int) -> Union[Risk,str]:
        ...
        result = self._queryDB(query, (id,), fetch_one=True, error_message='An error ocurred while retrieving the risk from the database')
    ...
    def getRisksByString(self, string: str) -> Union[list[Risk],str]:
        ...
        results = self._queryDB(query, (f'%{string}%', f'%{string}%'), fetch_all=True, error_message='An error ocurred while retrieving the risks from the database')
    ...
    def getRisksByProbability(self, probability: Classification) -> Union[list[Risk],str]:
        ...
        results = self._queryDB(query, (probability.value,), fetch_all=True, error_message='An error ocurred while retrieving the risks from the database')
        return results if isinstance(results, str) else [Risk(*result) for result in results]
    ...
    def getRisksByImpact(self, impact: Classification) -> Union[list[Risk],str]:
        ...
        results = self._queryDB(query, (impact.value,), fetch_all=True, error_message='An error ocurred while retrieving the risks from the database')
        
        return results if isinstance(results, str) else [Risk(*result) for result in results]

    def getRisksByUser(self, user: User) -> Union[list[Risk],str]:
        query = 'SELECT q.`id`, q.`name`, q.`description`, q.`probability`, q.`impact`, q.`created_at`, q.`updated_at` FROM (SELECT `id`, `name`, `description`, `probability`, `impact`, `created_at`, `updated_at` FROM `risk`  INNER JOIN `risk_user` ON `risk`.`id` = `risk_user`.`risk_id` WHERE `risk_user`.`user_id` = %s) AS q'

        results = self._queryDB(query, (user.id,), fetch_all=True, error_message='An error ocurred while retrieving the risks from the database')
    ...
    def getRisksByProvider(self, provider: Provider) -> Union[list[Risk],str]:
        ...
        results = self._queryDB(query, (provider.id,), fetch_all=True, error_message='An error ocurred while retrieving the risks from the database')
        
        return results if isinstance(results, str) else [Risk(*result) for result in results]
    
    def getRisksByCountry(self, country: str) -> Union[list[Risk],str]:
        query = 'SELECT q.`id`, q.`name`, q.`description`, q.`probability`, q.`impact`, q.`created_at`, q.`updated_at` FROM (SELECT `id`, `name`, `description`, `probability`, `impact`, `created_at`, `updated_at` FROM `risk`  INNER JOIN `provider` ON `risk`.`provider_id` = `provider`.`id` WHERE `provider`.`country` = %s) AS q'

        results = self._queryDB(query, (country,), fetch_all=True, error_message='An error ocurred while retrieving the risks from the database')

        return results if isinstance(results, str) else [Risk(*result) for result in results]
    
    def getAllRisks(self) -> Union[list[Risk],str]:
        query = 'SELECT `id`, `name`, `description`, `probability`, `impact`, `created_at`, `updated_at` FROM `risk`'

        results = self._queryDB(query, fetch_all=True, error_message='An error ocurred while retrieving the risks from the database')
        
        return results if isinstance(results, str) else [Risk(*result) for result in results]

    def getAllRisksWithUser(self) -> Union[list[Risk],str]:
        query = 'SELECT q.`id`, q.`name`, q.`description`, q.`probability`, q.`impact`, q.`created_at`, q.`updated_at`, q.`user_id` FROM (SELECT `id`, `name`, `description`, `probability`, `impact`, `created_at`, `updated_at`, `user_id` FROM `risk`  INNER JOIN `risk_user` ON `risk`.`id` = `risk_user`.`risk_id`) AS q'
    ...
    def updateRisk(self, risk: Risk) -> Union[bool,str]:
        ...
        query = 'UPDATE `risk` SET `name` = %s, `description` = %s, `probability` = %s, `impact` = %s WHERE `id` = %s'

        return self._queryDB(query, (risk.name, risk.description, risk.probability.value, risk.impact.value, risk.id), error_message='An error ocurred while updating the risk in the database')

    def deleteRisk(self, id: int) -> Union[bool,str]:
        query = 'DELETE FROM `risk` WHERE `id` = %s'

        return self._queryDB(query, (id,), error_message='An error ocurred while deleting the risk from the database')

    def relateRiskToUser(self, risk_id:int, user_id:int) -> Union[bool,str]:
        query = 'INSERT INTO `risk_user` (`risk_id`, `user_id`) VALUES (%s, %s)'

        return self._queryDB(query, (risk_id, user_id), error_message='An error ocurred while relating the risk to the user in the database')
    ...
    def unrelateRiskToUser(self, risk_id:int, user_id:int) -> Union[bool,str]:
        ...
        return self._queryDB(query, (risk_id, user_id), error_message='An error ocurred while unrelating the risk to the user in the database')